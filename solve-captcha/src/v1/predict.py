...
def main():
    ...
    parser.add_argument("--model_path", type=str, default="model/v1/captcha_model.pth", help="Đường dẫn đến file model (.pth)")
    parser.add_argument("--alphabet_path", type=str, default="model/v1/alphabet.json", help="Đường dẫn đến file alphabet.json")
