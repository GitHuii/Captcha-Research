"""
Kiến trúc ResNet34 Spatial Pooling cho nhận diện CAPTCHA 4 ký tự.
Độ phân giải đầu vào: 80x256.
"""
import torch.nn as nn
import torchvision.models as models


class SpatialResNet34(nn.Module):
    """ResNet34 backbone với Spatial Pooling (2x4) cho 4 ký tự CAPTCHA."""

    def __init__(self, num_classes):
        super().__init__()
        r = models.resnet34(weights='IMAGENET1K_V1')
        self.conv1 = r.conv1
        self.bn1 = r.bn1
        self.relu = r.relu
